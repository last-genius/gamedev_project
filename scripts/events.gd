...
export var upgrade_prices = {"health": [1, 3], "crew": [5, 0],
							"speed": [5, 2]}
export var weapon_prices = {"short_cannon": [20, 20], "long_cannon": [30, 30]}
export var stats = {"health": 20, "crew": 10, 
			"speed": 10, "gold": 90, "wood": 90,
			"short_cannon": 3, "long_cannon": 0}
export var max_stats = {"health": 99, "crew": 99, 
			"speed": 30, "short_cannon": 7, "long_cannon": 7}

func _ready():
	# warning-ignore:return_value_discarded
	connect("enemy_killed", self, "enemy_killed")
	# warning-ignore:return_value_discarded
	connect("stat_changed", self, "_on_stat_change")
...
func _on_stat_change(stat_name: String, value: int):
